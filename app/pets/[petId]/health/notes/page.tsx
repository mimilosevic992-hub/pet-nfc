...
export default function NotesPage() {
  ...
  async function add() {
    ...
    if (!title.trim()) return setErr("Upiši naslov beleške.");
      ...
      <div className="mx-auto max-w-4xl space-y-4">
        <div className="rounded-2xl bg-white p-6 shadow">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold">Ostale beleške</h1>
              <p className="mt-1 text-sm text-gray-600">Sve ostalo što želiš da zabeležiš.</p>
            </div>
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2">
            ...
            <div>
              ...
              <input
                ...
                placeholder="npr. Promena hrane / Napomena za groomera"
              />
            </div>

            <div className="sm:col-span-2">
              <label className="text-sm font-medium">Tekst beleške</label>
              <textarea
                className="mt-1 w-full rounded-xl border px-3 py-2"
                rows={4}
                value={notes}
                ...
                <div key={x.id} className="rounded-2xl border p-4">
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      ...
                      <div className="mt-1 text-sm text-gray-600">Datum: {x.date || "-"}</div>
